...
[position layer=message0 page=fore margint="101" marginl="226" marginr="226" marginb="25"]
# あかり
　どうしたって、コルデリアちゃんが屋根の上にいるのが見えたから。[r]
...
# コルデリア
　城の屋根の上からが、星が一番良く見えるのです。[r]
　その・・・粗相をしてしまった日などはよく当てもなく星を眺めています。[r]
  気が・・・紛れるので・・・[p]

[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　コルデリアちゃんが驚いた顔からうつむきながらどことなく恥ずかしそうな表情に変化する。[r]
...
[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　パッと電球がついたみたいにコルデリアちゃんは弾けるような笑顔を浮かべた。[r]
　落ち込んだ顔から、怪訝そうな顔、そして弾けるような笑顔。[r]
...
[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　促され、コルデリアちゃんの部屋に入る。[r]
　屋根裏部屋というのだろうか？[r]
  窓際に行くに連れて低くなっていく天井と、１つだけある小さな窓。[r]
　元の世界の私の部屋を基準にしても小さい部屋の中には木製の簡素なベッドと机、クローゼットが置かれている。[p]
　あまり他人の部屋をジロジロと観察するのは良くないと思いつつも、[r]
...
#
　部屋の中にいるより強い風が冷や汗を乾かしていく。[r]
　屋根瓦の一部をくり抜き、そこを窓にした構造の屋根であるため、 懸垂の要領で屋根へ出なければいけないといったことはなかったけれど、屋根の角度の傾斜はかなり大きい。[r]
...
[bg storage="hoshizora_tachie.jpg"]

[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　屋根の頂点。[r]
  やっとの思いでコルデリアちゃんの横に腰掛けると、コルデリアちゃんは夜空を指差しながらそういった。[r]
　私もその指を追うようにして夜空を見上げる。[p]
　そこには満点の星空が広がっていた。[p]
[position layer=message0 page=fore margint="101" marginl="226" marginr="226" marginb="25"]
...
　星のあかりを打ち消す程の光、それに星空を再現する機械・・・[r]
  王子様のいらした世界はとても発展しているのですね。[r]
  私にはとても想像がつきません。[p]
　でも、とっても面白いです。[r]
  街が栄えて、その街あかりで星が見えなくなり、[r]
...
#
　光害。[r]
  社会科見学で訪れたプラネタリウムの係の人が言っていた。[r]
  街の明かりで星空が見えなくなることをそういうんだと。[r]
　プラネタリウムを最初に作った人はどう思いながらそれを作ったのだろう？[r]
  街の発展とともに夜も明が増え、 見えなくなった星空を懐かしく思いながら作ったのだろうか？[p]
　ただ今はそのプラネタリムがある科学館も、夜になれば電気をつける。[r]
  そのあかりで星空は見えなくなる。[p]
...
[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　メイド服のポケットから取り出されたものは・・・虫眼鏡？[r]
　丸い凸レンズが木製の枠にはめ込まれ、持ち手がつけられている。[p]

[position layer=message0 page=fore margint="101" marginl="226" marginr="226" marginb="25"]

# コルデリア
　あるとき、水滴を通してものを見たときにそれが大きく見える事に気づきました。[r]
  それを真似、星や月を大きく見てみようと、ガラスを磨いて作ってみました。[r]
　ですが、思った通り大きく見れなくて・・・[p]
...
#
　物理の授業を思い出す。[l][r]
  凸レンズや凹レンズ、それらの焦点距離や倍率を計算するレンズの公式・・・[r]
...
[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　そう言うと、コルデリアちゃんの表情が暗くなる。[r]
　それを見て私は不安になった。[r]
　また私は相手の都合を考えず、自分の考えを押し付けてしまっているのだろうか？[r]
...
[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　コルデリアちゃんの表情がパァッとまるで電灯のスイッチを入れたかのように明るくなる。[r]
　先程までの私の不安は杞憂だったことがわかったほっとする。[p]

[position layer=message0 page=fore margint="101" marginl="226" marginr="226" marginb="25"]
# あかり
　もちろんいいんだけど、明日でもいいかな？[r]
　そろそろ眠くなってきちゃった。[p]

[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　そのせいで気が抜けたのか、思わずあくびが漏れる。[r]
　時計がないからわかりづらいが、夜もかなり遅い。[r]
...
[position layer=message0 page=fore margint="20" marginl="226" marginr="226" marginb="25"]
#
　部屋まで戻り、コルデリアちゃんにパジャマに着替えさせてもらい、豪奢なベットに潜り込む。[r]
　このあたりの記憶は少し曖昧だ。[l][r]
　目を閉じると先程のコルデリアちゃんの笑顔が脳裏に映る。[r]
　かわいい、と思うと同時に、眠気で意識が薄れていった・・・・[p]


[position layer=message0 page=fore visible=false opacity=0]
[wait time="2000"]
